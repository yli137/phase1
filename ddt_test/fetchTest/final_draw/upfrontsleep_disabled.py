...
t0 = pd.read_csv('disabled/ufs_t0_disabled.txt', sep=' ', names=col).iloc[:, -2]
t1 = pd.read_csv('disabled/ufs_t1_disabled.txt', sep=' ', names=col).iloc[:, -2]
t2 = pd.read_csv('disabled/ufs_t2_disabled.txt', sep=' ', names=col).iloc[:, -2]
...
fig.suptitle('prefetch upfront sleep 1 nanosecond hardware prefetch disabled')
