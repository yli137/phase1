...
t0 = pd.read_csv('disabled/ufp_t0_disabled.txt', sep=' ', names=col).iloc[:, -2]
t1 = pd.read_csv('disabled/ufp_t1_disabled.txt', sep=' ', names=col).iloc[:, -2]
t2 = pd.read_csv('disabled/ufp_t2_disabled.txt', sep=' ', names=col).iloc[:, -2]
