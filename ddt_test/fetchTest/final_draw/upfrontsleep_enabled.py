...
t0 = pd.read_csv('enabled/ufs_t0_enabled.txt', sep=' ', names=col).iloc[:, -2]
t1 = pd.read_csv('enabled/ufs_t1_enabled.txt', sep=' ', names=col).iloc[:, -2]
t2 = pd.read_csv('enabled/ufs_t2_enabled.txt', sep=' ', names=col).iloc[:, -2]
...
fig.suptitle('prefetch upfront sleep 1 nanosecond hardware prefetch enabled')
