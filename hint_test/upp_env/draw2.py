...
nohint = pd.read_csv('nohintdata2.txt', sep=' ', names=col)
hint0 = pd.read_csv('hintdataT0Second2.txt', sep=' ', names=col)
hint1 = pd.read_csv('hintdataT1Second2.txt', sep=' ', names=col)
hint2 = pd.read_csv('hintdataT2Second2.txt', sep=' ', names=col)
...
ax[0,1].set_ylabel('Bandwidth (GBps)')
ax[0,2].set_xlabel('size (MB)')
ax[0,2].set_ylabel('Bandwidth (GBps)')
ax[0,3].set_xlabel('size (MB)')
ax[0,3].set_ylabel('Bandwidth (GBps)')
ax[1,0].set_xlabel('size (MB)')
ax[1,0].set_ylabel('Bandwidth (GBps)')
ax[1,1].set_xlabel('size (MB)')
ax[1,1].set_ylabel('Bandwidth (GBps)')
ax[1,2].set_xlabel('size (MB)')
ax[1,2].set_ylabel('Bandwidth (GBps)')
ax[1,3].set_xlabel('size (MB)')
ax[1,3].set_ylabel('Bandwidth (GBps)')

plt.legend(['nohint', 'hint T0', 'hint T1', 'hint T2'], bbox_to_anchor=(1, 0.5))
