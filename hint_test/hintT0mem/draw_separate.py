...
ax[1, 0].plot(size, _1nohintspeed, label="w/o hint", color='r')
ax[1, 1].plot(size, _1nohintspeed, label="w/o hint", color='r')
ax[1, 2].plot(size, _1nohintspeed, label="w/o hint", color='r')
ax[1, 3].plot(size, _1nohintspeed, label="w/o hint", color='r')
